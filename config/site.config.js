...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'admin@zw5qh.onmicrosoft.com',
  ...
  footer:
    'Powered by <a href="https://knloop.com/" target="_blank">knloop.com</a> with Cloudflare.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/🐔 nothing', '/🐔 nothing/std盛天', '/🐔 nothing/dr定制打包', '/🐔 nothing/zt费控'],
